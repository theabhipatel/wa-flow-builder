...
export default function PlainMessageNode({ data, selected }: any) {
  ...
  return (
    <div className="relative">
      <div
        className={`px-4 py-3 shadow-lg rounded-lg bg-white border-2 border-blue-400 min-w-[200px] transition-all ${
